...
function sendForm(data) {
    console.log(data);
    $.ajax({
        url: "https://docs.google.com/forms/d/e/1FAIpQLSc2bPWCILkgnbQ_vFQXpFIM6CSPZ3okInbNmjz_GwARt2fPbQ/formResponse",
        data: {
                    ...
                    <div class="modal__box">
                        ...
                        <div class="modal__body">
                            ...
                            <div class="modal__form">
                                ...
                                <div class="form-group">
                                    <input class="modal__input" id="product-m" type="text" placeholder="Sản phẩm muốn đăng ký vay mua nhà">
                                </div>
                    ...
                    <div class="modal__box">
                        ...
                        <div class="modal__body">
                            ...
                            <div class="modal__form">
                                ...
                                <div class="form-group">
                                    <input class="modal__input" id="product-m" type="text" placeholder="Sản phẩm muốn đăng ký vay kinh doanh">
                                </div>
                                <div class="modal__submit">
                                    <input class="button-1" id="submit-m" onclick="submitModal()" type="button" value="Đăng ký">
                                </div>
